...
// CUT begin
ifstream data("BicycleLock.sample");
...
bool do_test(vector<int> dials, string __expected) {
    time_t startClock = clock();
    BicycleLock *instance = new BicycleLock();
    string __result = instance->makeDistinct(dials);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "BicycleLock (250 Points)" << endl << endl;
    }
